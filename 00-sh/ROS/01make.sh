...
sleep 0.5
#x7s
gnome-terminal -t "L" -x  bash -c "cd ${workspace}; cd ../..; cd LIFT_ARM/ROS/R5Pro_ws; rm -rf build install log .catkin_workspace src/CMakeLists.txt;catkin_make; exec bash;"
sleep 0.5
