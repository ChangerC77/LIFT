...
#x7s
sleep 3
gnome-terminal -t "L" -x  bash -c "cd ${workspace}; cd ../../..; cd ARX_X5/ROS2/X5_ws; source install/setup.bash && ros2 launch arx_x5_controller open_vr_double_arm.launch.py; exec bash;"
